...
import * as import8 from '../../../../app/partials/header/header.component';
import * as import9 from './partials/header/header.component.ngfactory';
import * as import10 from '@angular/core/src/linker/view_container';
import * as import11 from '../../../node_modules/@angular/router/src/directives/router_outlet.ngfactory';
import * as import12 from '../../../../app/partials/footer/footer.component';
import * as import13 from './partials/footer/footer.component.ngfactory';
...
export class View_AppComponent0 extends import1.AppView<import0.AppComponent> {
  _el_0:any;
  compView_0:import1.AppView<import8.HeaderOutletComponent>;
  _HeaderOutletComponent_0_3:import9.Wrapper_HeaderOutletComponent;
  _text_1:any;
  _el_2:any;
  _text_3:any;
  _el_4:any;
  ...
  _text_6:any;
  _el_7:any;
  compView_7:import1.AppView<import12.FooterOutletComponent>;
  _FooterOutletComponent_7_3:import13.Wrapper_FooterOutletComponent;
  constructor(viewUtils:import3.ViewUtils,parentView:import1.AppView<any>,parentIndex:number,parentElement:any) {
  ...
  createInternal(rootSelector:string):import7.ComponentRef<any> {
    ...
    this._el_0 = import3.createRenderElement(this.renderer,parentRenderNode,'header-outlet',import3.EMPTY_INLINE_ARRAY,(null as any));
    this.compView_0 = new import9.View_HeaderOutletComponent0(this.viewUtils,this,0,this._el_0);
    this._HeaderOutletComponent_0_3 = new import9.Wrapper_HeaderOutletComponent();
    this.compView_0.create(this._HeaderOutletComponent_0_3.context);
    this._text_1 = this.renderer.createText(parentRenderNode,'\n',(null as any));
    this._el_2 = import3.createRenderElement(this.renderer,parentRenderNode,'main',new import3.InlineArray2(2,'class','container-fluid'),(null as any));
    ...
    this._el_7 = import3.createRenderElement(this.renderer,parentRenderNode,'footer-outlet',import3.EMPTY_INLINE_ARRAY,(null as any));
    this.compView_7 = new import13.View_FooterOutletComponent0(this.viewUtils,this,7,this._el_7);
    this._FooterOutletComponent_7_3 = new import13.Wrapper_FooterOutletComponent();
    this.compView_7.create(this._FooterOutletComponent_7_3.context);
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import8.HeaderOutletComponent) && (0 === requestNodeIndex))) { return this._HeaderOutletComponent_0_3.context; }
    if (((token === import16.RouterOutlet) && (4 === requestNodeIndex))) { return this._RouterOutlet_4_5.context; }
    if (((token === import12.FooterOutletComponent) && (7 === requestNodeIndex))) { return this._FooterOutletComponent_7_3.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    this._FooterOutletComponent_7_3.ngDoCheck(this,this._el_7,throwOnChange);
