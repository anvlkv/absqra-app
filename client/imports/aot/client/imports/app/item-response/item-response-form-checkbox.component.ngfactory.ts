...
import * as import0 from '../../../../../app/item-response/item-response-form-checkbox.component';
...
import * as import10 from '../../../../node_modules/@angular/forms/src/directives/reactive_directives/form_control_name.ngfactory';
import * as import11 from '../../../../node_modules/@angular/forms/src/directives/ng_control_status.ngfactory';
import * as import12 from '@angular/core/src/linker/view_container';
import * as import13 from '@angular/core/src/linker/element_ref';
import * as import14 from '@angular/forms/src/directives/checkbox_value_accessor';
...
export class Wrapper_ItemResponseFormCheckboxComponent {
  /*private*/ _eventHandler:Function;
  context:import0.ItemResponseFormCheckboxComponent;
  ...
  constructor() {
    this._changed = false;
    this.context = new import0.ItemResponseFormCheckboxComponent();
...
var renderType_ItemResponseFormCheckboxComponent_Host:import4.RenderComponentType = import3.createRenderComponentType('',0,import5.ViewEncapsulation.None,([] as any[]),{});
class View_ItemResponseFormCheckboxComponent_Host0 extends import2.AppView<any> {
  _el_0:any;
  compView_0:import2.AppView<import0.ItemResponseFormCheckboxComponent>;
  _ItemResponseFormCheckboxComponent_0_3:Wrapper_ItemResponseFormCheckboxComponent;
  constructor(viewUtils:import3.ViewUtils,parentView:import2.AppView<any>,parentIndex:number,parentElement:any) {
    super(View_ItemResponseFormCheckboxComponent_Host0,renderType_ItemResponseFormCheckboxComponent_Host,import6.ViewType.HOST,viewUtils,parentView,parentIndex,parentElement,import7.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import8.ComponentRef<any> {
    this._el_0 = import3.selectOrCreateRenderHostElement(this.renderer,'item-response-form-checkbox',import3.EMPTY_INLINE_ARRAY,rootSelector,(null as any));
    this.compView_0 = new View_ItemResponseFormCheckboxComponent0(this.viewUtils,this,0,this._el_0);
    this._ItemResponseFormCheckboxComponent_0_3 = new Wrapper_ItemResponseFormCheckboxComponent();
    this.compView_0.create(this._ItemResponseFormCheckboxComponent_0_3.context);
    this.init(this._el_0,((<any>this.renderer).directRenderer? (null as any): [this._el_0]),(null as any));
    return new import8.ComponentRef_<any>(0,this,this._el_0,this._ItemResponseFormCheckboxComponent_0_3.context);
  }
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import0.ItemResponseFormCheckboxComponent) && (0 === requestNodeIndex))) { return this._ItemResponseFormCheckboxComponent_0_3.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    this._ItemResponseFormCheckboxComponent_0_3.ngDoCheck(this,this._el_0,throwOnChange);
    this.compView_0.internalDetectChanges(throwOnChange);
  }
  destroyInternal():void {
    this.compView_0.destroy();
    this._ItemResponseFormCheckboxComponent_0_3.ngOnDestroy();
  }
  visitRootNodesInternal(cb:any,ctx:any):void {
    cb(this._el_0,ctx);
  }
}
export const ItemResponseFormCheckboxComponentNgFactory:import8.ComponentFactory<import0.ItemResponseFormCheckboxComponent> = new import8.ComponentFactory<import0.ItemResponseFormCheckboxComponent>('item-response-form-checkbox',View_ItemResponseFormCheckboxComponent_Host0,import0.ItemResponseFormCheckboxComponent);
const styles_ItemResponseFormCheckboxComponent:any[] = ([] as any[]);
class View_ItemResponseFormCheckboxComponent1 extends import2.AppView<any> {
  _el_0:any;
  _text_1:any;
  _el_2:any;
  _text_3:any;
  ...
  _FormControlName_4_5:import10.Wrapper_FormControlName;
  _NgControl_4_6:any;
  ...
  constructor(viewUtils:import3.ViewUtils,parentView:import2.AppView<any>,parentIndex:number,parentElement:any,declaredViewContainer:import12.ViewContainer) {
    super(View_ItemResponseFormCheckboxComponent1,renderType_ItemResponseFormCheckboxComponent,import6.ViewType.EMBEDDED,viewUtils,parentView,parentIndex,parentElement,import7.ChangeDetectorStatus.CheckAlways,declaredViewContainer);
  ...
  createInternal(rootSelector:string):import8.ComponentRef<any> {
    ...
    this._CheckboxControlValueAccessor_4_3 = new import9.Wrapper_CheckboxControlValueAccessor(this.renderer,new import13.ElementRef(this._el_4));
    this._NG_VALUE_ACCESSOR_4_4 = [this._CheckboxControlValueAccessor_4_3.context];
    this._FormControlName_4_5 = new import10.Wrapper_FormControlName((<View_ItemResponseFormCheckboxComponent0>this.parentView)._ControlContainer_0_4,(null as any),(null as any),this._NG_VALUE_ACCESSOR_4_4);
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import14.CheckboxControlValueAccessor) && (4 === requestNodeIndex))) { return this._CheckboxControlValueAccessor_4_3.context; }
    if (((token === import15.NG_VALUE_ACCESSOR) && (4 === requestNodeIndex))) { return this._NG_VALUE_ACCESSOR_4_4; }
    if (((token === import16.FormControlName) && (4 === requestNodeIndex))) { return this._FormControlName_4_5.context; }
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    const currVal_4_1_0:any = this.context.$implicit.name;
    ...
    const currVal_12:any = this.parentView.context.describedby;
    if (import3.checkBinding(throwOnChange,this._expr_12,currVal_12)) {
      this.renderer.setElementAttribute(this._el_4,'aria-describedby',((currVal_12 == null)? (null as any): currVal_12.toString()));
...
var renderType_ItemResponseFormCheckboxComponent:import4.RenderComponentType = import3.createRenderComponentType('',0,import5.ViewEncapsulation.None,styles_ItemResponseFormCheckboxComponent,{});
export class View_ItemResponseFormCheckboxComponent0 extends import2.AppView<import0.ItemResponseFormCheckboxComponent> {
  _el_0:any;
  _FormGroupDirective_0_3:import19.Wrapper_FormGroupDirective;
  ...
  _text_3:any;
  constructor(viewUtils:import3.ViewUtils,parentView:import2.AppView<any>,parentIndex:number,parentElement:any) {
    super(View_ItemResponseFormCheckboxComponent0,renderType_ItemResponseFormCheckboxComponent,import6.ViewType.COMPONENT,viewUtils,parentView,parentIndex,parentElement,import7.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import8.ComponentRef<any> {
    ...
    this._FormGroupDirective_0_3 = new import19.Wrapper_FormGroupDirective((null as any),(null as any));
    ...
    this._NgFor_2_6 = new import20.Wrapper_NgFor(this._vc_2.vcRef,this._TemplateRef_2_5,this.parentView.injectorGet(import22.IterableDiffers,this.parentIndex),this.ref);
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import24.FormGroupDirective) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 3)))) { return this._FormGroupDirective_0_3.context; }
    if (((token === import25.ControlContainer) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 3)))) { return this._ControlContainer_0_4; }
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    const currVal_2_0_0:any = this.context.choices;
  ...
  createEmbeddedViewInternal(nodeIndex:number):import2.AppView<any> {
    if ((nodeIndex == 2)) { return new View_ItemResponseFormCheckboxComponent1(this.viewUtils,this,2,this._anchor_2,this._vc_2); }
    return (null as any);
  }
